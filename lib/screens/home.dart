...
class _HomeState extends State<Home> with SingleTickerProviderStateMixin {
  ...
  int screenIndex = ScreenSelected.homepage.value;
  ...
  Widget createScreenFor(ScreenSelected screenSelected) {
    switch (screenSelected) {
      case ScreenSelected.homepage:
        return HomePage(requestOpenSearchDelegate: requestOpenSearchDelegate);
      case ScreenSelected.prifile:
        return Profile(
          callback: () {},
        );
